...
- **uv** + **ruff** + **pytest** — packaging, linting, testing (388 tests)
...
- **Lucide** icons, self-hosted **Figtree / JetBrains Mono** variable fonts and **Shadows Into Light Two** for eyebrows (headlines in **Logical**, Griddo's typeface, when available), **uqr** for QR codes
...
The project includes a comprehensive test suite with **388 passing tests**:
